        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalCode = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hospitals_AspNetUsers_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedWorkerSpeciality", x => new { x.MedWorkersId, x.SpecialitiesSpecialityId });
                    table.ForeignKey(
                        name: "FK_MedWorkerSpeciality_AspNetUsers_MedWorkersId",
                        column: x => x.MedWorkersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HospitalMedWorker", x => new { x.HospitalsHospitalId, x.MedWorkersId });
                    table.ForeignKey(
                        name: "FK_HospitalMedWorker_AspNetUsers_MedWorkersId",
                        column: x => x.MedWorkersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalMedWorker_MedWorkersId",
                table: "HospitalMedWorker",
                column: "MedWorkersId");

            migrationBuilder.CreateIndex(
                name: "IX_Hospitals_PatientId",
                table: "Hospitals",
                column: "PatientId");
